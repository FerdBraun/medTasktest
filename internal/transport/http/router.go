...
func NewRouter(taskHandler *httphandlers.TaskHandler, docsHandler *swaggerdocs.Handler, uiHandler *uihandlers.Handler) *mux.Router {
	router := mux.NewRouter().StrictSlash(true)

	// UI
	router.HandleFunc("/", uiHandler.ServeUI).Methods(http.MethodGet)
